...
'''
# 参数设置
strategyName = 'HullMacdBiasWin'
exchange_id = 'SHFE'
sec_id = 'RB'
K_MIN = 3600
startdate = '2010-01-01'
enddate = '2018-07-01'
parasetname = 'ParameterSet_MACD_Bias.csv'
...
ownlTargetStart_close = 0.006
ownltargetEnd_close = 0.012
nolossThreshhold_close = 3
# frsl参数
frslStep_close = -0.001
frslTargetStart_close = -0.008
frslTragetEnd_close = -0.012
# =============推进控制开关===================
# nextMonthName='18-05'
forwardWinStart = 1
forwardWinEnd = 12
