...
def HopeWin_MACD_MA(symbolInfo,setname,K_MIN,startdate,enddate,macdParaSet,contractswaplist,calcResult=True):
    print setname
    rawdata_macd = DC.getBarData(symbolInfo.symbol, K_MIN, startdate + " 00:00:00", enddate + " 23:59:59")
